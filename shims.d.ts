...
declare namespace brightboard {
     ...
     */
    //% blockId=brightboard_setDotStarSPIMode block="set bits %bits| and mode %mode" shim=brightboard::setDotStarSPIMode
    function setDotStarSPIMode(bits: int32, mode: int32): void;
